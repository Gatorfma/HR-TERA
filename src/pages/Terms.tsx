      ...
      <main className="pt-24 pb-16">
        <div className="container max-w-4xl">
          ...
          <section className="space-y-6 text-muted-foreground">
            <p>
              These Terms of Service ("Terms") govern your use of HRHub and related
              services (the "Service"). By accessing or using the Service, you agree
              to these Terms.
            </p>

            <div>
              <h2 className="text-xl font-heading font-bold text-foreground mb-2">About HRHub</h2>
              <p>
                HRHub provides a marketplace-style directory of HR products and vendors.
                We offer informational listings and tools to help users discover solutions.
                HRHub is not a party to agreements between vendors and customers.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                HRHub. We do not guarantee the accuracy, availability, or suitability of
                any listing. If you submit content, you grant HRHub a non-exclusive license
            ...
            <div>
              ...
              <p>
                The Service may link to third-party sites. HRHub does not control these
            ...
            <div>
              ...
              <p>
                The Service is provided "as is" without warranties of any kind. HRHub
            ...
            <div>
              ...
              <p>
                To the maximum extent permitted by law, HRHub will not be liable for any
