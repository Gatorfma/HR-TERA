...
const tr: Record<string, string> = {
  ...
  "hero.searchPlaceholder": "Çözüm veya Şirket Ara",
  ...
  "products.vendorTier": "Şirket Üyeliği",
  "products.category": "Kategori",
  "products.allTiers": "Tüm Abonelikler",
  "products.premium": "Premium",
  "products.plus": "Plus",
  ...
  "vendors.subtitle": "Pazaryerindeki en yüksek puanlı premium şirketler",
  "vendors.browseAll": "Tümünü gör",
  "vendors.searchPlaceholder": "Şirket Ara",
  "vendors.showing": "Gösterilen",
  "vendors.vendorsCount": "şirket",
  "vendors.noVendors": "Şirket bulunamadı.",
  "vendors.vendorTier": "Şirket Seviyesi",
  "vendors.vendorType": "Şirket Türü",
  ...
  "ownership.previewDesc": "Şirket kartınız böyle görünecek.",
  ...
  "footer.newsletter.desc": "Profil oluşturun, şirketlerle bağlantı kurun veya İK topluluğunuzu oluşturun.",
  ...
  "productDetail.contactVendor": "Şirket ile İletişime Geç",
  ...
  "settings.billing.unlockPlus2": "Çözüm galerileri ve ekran görüntüleri",
  ...
  "settings.billing.unlockPremium2": "Çözüm analitiği ve içgörüler",
