...
const en: Record<string, string> = {
  ...
  "vendors.subtitle": "Top-rated gold vendors in the marketplace",
  ...
  "ownership.tierSilverLabel": "Silver",
  "ownership.tierSilverSubtitle": "Featured visibility",
  "ownership.tierSilverPrice": "$99 / mo",
  "ownership.tierSilverDesc": "Boosted visibility and analytics.",
  "ownership.tierGoldLabel": "Gold",
  "ownership.tierGoldSubtitle": "Premium reach",
  "ownership.tierGoldPrice": "$199 / mo",
  "ownership.tierGoldDesc": "Top placement with priority support.",
  ...
  "settings.billing.unlockSilverTitle": "Unlock with Silver:",
  "settings.billing.unlockSilver1": "Multiple categories and detailed descriptions",
  "settings.billing.unlockSilver2": "Product galleries and screenshots",
  "settings.billing.unlockSilver3": "Customer reviews management",
  "settings.billing.unlockGoldTitle": "Unlock with Gold:",
...
const tr: Record<string, string> = {
  ...
  "vendors.subtitle": "Pazaryerindeki en yüksek puanlı altın satıcılar",
  ...
  "ownership.tierSilverLabel": "Silver",
  "ownership.tierSilverSubtitle": "Öne çıkan görünürlük",
  "ownership.tierSilverPrice": "$99 / ay",
  "ownership.tierSilverDesc": "Daha yüksek görünürlük ve analitik.",
  "ownership.tierGoldLabel": "Gold",
  "ownership.tierGoldSubtitle": "Premium erişim",
  "ownership.tierGoldPrice": "$199 / ay",
  "ownership.tierGoldDesc": "En üst görünürlük ve öncelikli destek.",
  ...
  "settings.billing.unlockSilverTitle": "Silver ile açılır:",
  "settings.billing.unlockSilver1": "Birden çok kategori ve detaylı açıklamalar",
  "settings.billing.unlockSilver2": "Ürün galerileri ve ekran görüntüleri",
  "settings.billing.unlockSilver3": "Müşteri yorumlarını yönetme",
  "settings.billing.unlockGoldTitle": "Gold ile açılır:",
